  ...
  btns.forEach(btn => {
    btn.addEventListener('click', (e)=>{
      ...
      /* active the button only when it is the current questions*/
      ...
      btn.classList.toggle("rotate");
        ...
        /* Look if the answer corresponding to the current questions */
        ...
        /* Look if the title corresponding to the current questions */
