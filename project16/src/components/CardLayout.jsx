...
const CardLayout =()=>{
  return(
    <div className="md:h-screen">
      ...
      <img src={bg2} alt="background" className="absolute -z-10 top-0  w-full left-0 right-0 flex md:hidden" /> {/*mobile background */}
                  ...
                  <div className="absolute top-0 flex flex-col h-full w-full">
                    ...
                    <div className="h-full  w-full flex flex-col justify-end gap-4 md:gap-5 px-5 md:px-8 pb-4 md:pb-7">
                      <div className="flex justify-center">
                          <p className="text-xl md:text-2xl lg:text-3xl text-white tracking-[.17rem] z-10">0000 0000 0000 0000</p>   {/*code */}  
                       </div>

                          <div className="flex justify-between">
                             <p className="text-sm lg:text-1xl text-white tracking-[.09rem] z-10 uppercase">Jane Appleseed</p>  {/*name */} 
                             <p className="text-sm lg:text-1xl text-white tracking-[.09rem] z-10">00/00</p>   {/*date */} 
                          </div>
                    </div>    
              ...
              <div className="relative w-fit ">
                <img src={backCard} alt="backCard" className="w-[20rem] md:w-full" />
                    <div className="absolute top-0 flex flex-col h-full w-full justify-center items-end pe-12">
                       <p className="text-sm md:text-xl text-white tracking-[.09rem] z-10">000</p>   {/*CVC */}
                     </div>
               </div>
          </div>
